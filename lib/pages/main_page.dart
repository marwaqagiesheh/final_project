                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: IconButton(
                              ...
                              icon: const Icon(Icons.add_box, color: Colors.green, size: 70,
                              )),
                        )
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        Row(
                          children: [
                            Text(
                              reminderDate!, style: TextStyle(color: Colors.green),
                            ),
                            IconButton(
                              onPressed: (() async {
                            ...
                            child: Row(
                              children: [
                                Text(provider.types[index].typeName!,
                                  style: TextStyle(color: provider.types[index].typeName == reminderType ? Colors.green : Colors.white),
                                ),
                                Icon(provider.types[index].typeIcon, color: provider.types[index].typeName == reminderType ? Colors.green : Colors.white,
                                )
                              ],
                            ),
                          );
